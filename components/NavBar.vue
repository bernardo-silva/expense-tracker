...
<template>
  <div class="navbar bg-base-100 justify-between">
    <div class="flex-none">
      <label
for="drawer" aria-label="open sidebar" class="btn btn-square btn-ghost lg:hidden"
        :class="{ 'hidden': !auth.isLoggedIn }">
        <svg
xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
    ...
    <div class="mx-2 flex-2" :class="{ 'lg:hidden': auth.isLoggedIn }">
